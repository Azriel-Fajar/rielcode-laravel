...
class CheckoutController extends Controller
{
    public function show(Request $request)
    {
        ...
        $addonsTotal = (int) $order->addons_total;
    ...
    public function confirm(Request $request)
    {
        ...
        $finalPrice = $packagePrice + (int) $order->addons_total;
        ...
        $order->update([
            ...
            'addons_total' => (int) $order->addons_total,
        ...
        $briefUrl = config('app.portal_urls.progress').'/brief?t='.$progressToken;

        // Send confirmation email
        try {
            Mail::to($order->email, $order->order_name)->send(new OrderConfirmationMail($order, $progressToken, $briefUrl));
