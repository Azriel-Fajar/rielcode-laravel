...
>
    <section class="rc-prose-hero">
        <div class="rc-container rc-prose-hero__inner">
            ...
            <p class="rc-prose-hero__meta rc-label">Last updated: 2026-05-21</p>
        </div>
    </section>
    ...
    <section class="rc-prose-body">
        <div class="rc-container">
            <div class="rc-prose">
                ...
                <p>Inquiry messages are retained for as long as the client relationship is active, then deleted within 90 days of project close. You may request deletion at any time by emailing <a href="mailto:info@rielcode.com">info@rielcode.com</a>.</p>

                <h2>5. Your rights</h2>
                <p>You have the right to access, correct, or delete any personal data we hold about you. To exercise these rights, contact us at <a href="mailto:info@rielcode.com">info@rielcode.com</a>. We will respond within 5 business days.</p>
