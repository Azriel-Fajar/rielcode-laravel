...
<title>Brief Received | Rielcode</title>
</head>
    ...
    <tr>
        <td style="padding:32px;">
            ...
            <p style="margin:0 0 16px;font-size:15px;color:#333;line-height:1.6;">
                We've received your project brief — thank you! Our team will review it and get to work on your <strong>{{ $order->package }}</strong> project.
            </p>
            <p style="margin:0 0 16px;font-size:15px;color:#333;line-height:1.6;">
                You can now track your project progress anytime via your private link:
            </p>
